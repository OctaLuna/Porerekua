...
const OrganizationModal: React.FC<Props> = ({ onClose, isNested }) => {
  ...
  const onSubmit = async (data: OrganizationFormData) => {
    console.groupCollapsed('[Formulario Organizaciones] Envío al backend');
    try {
      setIsSubmitting(true);
      setSubmitError(undefined);
      setSubmitTechnical(undefined);
      console.log('Datos capturados desde el formulario de organizaciones', data);
      ...
      console.log('Datos normalizados para el payload (organizaciones)', normalized);
      const payload = mapOrganizationFormToDto(normalized);
      console.log('Payload preparado para la API (organizaciones)', payload);
      const response = await apiClient.post<CommonResponseDto>('/api/formularios/organizaciones', payload);
      console.log('Respuesta recibida del backend (organizaciones)', response);
      clearDraft();
      setIsSuccess(true);
      setSuccessMessage(response?.message);
    } catch (error) {
      console.error('Error al enviar formulario de organizaciones', error);
            ...
            >
              ...
              {!loadingOptions && formOptions && (
                <>
                  ...
                  <Select
                    ...
                    error={errors.tipo?.id?.message as string | undefined}
                  >
                  ...
                  {selectedType === OTHER_OPTION && (
                    <Input
                      ...
                      error={errors.tipo?.otros?.message as string | undefined}
                    />
                  )}
                  ...
                  <Select
                    ...
                    error={errors.idDepartamento?.message as string | undefined}
                  >
                    <option value="">Seleccione...</option>
                  ...
                  <Select
                    ...
                    error={errors.esNacional?.message as string | undefined}
                  >
                    <option value="">Seleccione...</option>
                  ...
                  <Input
                    ...
                    error={errors.anioInicioTrabajo?.message as string | undefined}
                  />
              ...
              <div className="flex justify-end gap-3">
                ...
                <Button 
                  ...
                  onClick={isNested ? () => handleSubmit(onSubmit)() : undefined}
                >
