  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.color = 'rgba(244,244,244,0.78)'; }}
              onMouseLeave={e => { e.currentTarget.style.color = 'rgba(244,244,244,0.38)'; }}
            >
        ...
        <Routes>
          <Route path="empresa" element={<RegistrationModal onClose={() => { void navigate('/registro'); }} />} />
          <Route path="organizacion" element={<OrganizationModal onClose={() => { void navigate('/registro'); }} />} />
        </Routes>
      </div>
    </>
  );
